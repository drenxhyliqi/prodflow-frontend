...
export default function SalesReport() {
    const { checking, denied, startDate, endDate, withRunId, runId } = useReportAccess('sales')
            ...
            <div className="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
                <div>
                    ...
                    <small style={{ color: '#6b7280' }}>
                        {startDate && endDate ? `${startDate} — ${endDate}` : 'Business analytics · Revenue & orders'}
                    </small>
                </div>
                <button
                    type="button"
